...
- Remaining: Install older iOS simulator runtimes for App Store screenshots, add 4 new Swift files to Xcode, set developer team, story/feed/reel template redesign (remove emojis, use SVG icons), hero rotating text, blog dynamic OG, Watch/Widget targets, StoreKit config, App Store submission
